...
function preload() {
    ...
    player2_img = loadImage("assets/45-unscreen.gif");
...
function spawnEnemiesLvl2(){
  if(frameCount%100 == 0){
    ...
    console.log("random value" + random);
    enemylvl2 = createSprite(720, 490);
    ...
    switch(random){
      case 1: 
       ...
       enemylvl2.velocityX = -2;
        break;
      case 2:
        enemylvl2.addImage(enemy6)
        enemylvl2.scale = 0.4;
        enemylvl2.velocityX = -2;
        break;
      case 3:
        enemylvl2.addImage(enemy7)
        enemylvl2.scale = 0.3;
        enemylvl2.velocityX = -2;
        break;
      case 4:
